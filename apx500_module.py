...
sys.path.append(r"C:\Program Files (x86)\Audio Precision\APx500 4.3\API") # Set the path to import the Apx API
sys.path.append(r"C:\Program Files (x86)\Audio Precision\APx500 4.3\API\Python") # Set the path to import the Apx python sampleProject
...
clr.AddReference("C:\Program Files (x86)\Audio Precision\APx500 4.3\API\AudioPrecision.API2.dll")
clr.AddReference("C:\Program Files (x86)\Audio Precision\APx500 4.3\API\AudioPrecision.API.dll")
